          ...
          <View style={styles.content}>
            ...
            <View style={styles.header}>
              <View style={styles.progressTrack}>
                ...
                <View style={[styles.progressActive, { width: '85%' }]} />
              </View>
            ...
            <View style={styles.textWrapper}>
              ...
              <Text style={styles.subtitle}>
                Choose an amount that works for you and a repayment plan you can manage comfortably.
              </Text>
            </View>
            ...
            <View style={styles.footer}>
              <TouchableOpacity 
                ...
                onPress={() => router.push("/onboarding/five")}
              >
